...
var PushValuesStream = (function (_Transform2) {
  _inherits(PushValuesStream, _Transform2);
...
var MapAsyncStream = (function (_Transform3) {
  _inherits(MapAsyncStream, _Transform3);
...
var ThroughAsyncStream = (function (_Transform4) {
  _inherits(ThroughAsyncStream, _Transform4);
...
var MapSyncStream = (function (_Transform5) {
  _inherits(MapSyncStream, _Transform5);
...
var ThroughStream = (function (_Transform6) {
  _inherits(ThroughStream, _Transform6);
...
var FilterStream = (function (_Transform7) {
  _inherits(FilterStream, _Transform7);

  function FilterStream(fn) {
    _classCallCheck(this, FilterStream);

    _get(Object.getPrototypeOf(FilterStream.prototype), 'constructor', this).call(this, { objectMode: true });
    this.fn = fn;
  }
